...
local palette = {
  ...
  yellow = swatches.yellow2,
  green = swatches.green2,
  cyan = swatches.cyan2,
  blue = swatches.blue2,
  pink = swatches.pink2,
...
local function generate(cp)
  ...
  return {
    ...
    -- Git diff
    diff_add = cp.diff_add or swatches.green6,
    diff_delete = cp.diff_delete or swatches.red6,
    diff_text = cp.diff_text or swatches.white4,
