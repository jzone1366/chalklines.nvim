...
function M.groups(theme)
  ...
  return {
    ...
    TSAnnotation = { fg = theme.palette.pink }, -- For C++/Dart attributes, annotations that can be attached to the code to denote some kind of meta information.
    ...
    TSParameter = { fg = theme.palette.pink, style = config.options.italic }, -- For parameters of a function.
    TSParameterReference = { fg = theme.palette.pink }, -- For references to parameters of a function.
    TSProperty = { fg = theme.palette.pink }, -- Same as `TSField`.
    ...
    TSSymbol = { fg = theme.palette.pink }, -- For identifiers referring to symbols or atoms.
    TSTag = { fg = theme.palette.pink }, -- Tags like html tag names.
