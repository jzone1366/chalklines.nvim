...
function M.groups(theme)
  ...
  return {
    ...
    Constant = { fg = theme.palette.orange }, -- (preferred) any constant
    ...
    Number = { fg = theme.palette.orange }, -- a number constant: 234, 0xff
    ...
    Conditional = { fg = theme.palette.purple, style = config.options.italic }, --  if, then, else, endif, switch, etc
    Repeat = { fg = theme.palette.purple }, -- for, do, while, etc
    Label = { fg = theme.palette.pink }, -- case, default, etc

    Operator = { fg = theme.palette.cyan, style = config.options.italic }, -- "sizeof", "+", "*", etc
    Keyword = {
    ...
    Type = { fg = theme.palette.yellow }, -- (preferred) int, long, char, etc
