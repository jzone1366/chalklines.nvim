...
function M.groups(theme)
  ...
  return {
    ...
    -- CursorIM     = {bg = theme.palette.pink}, -- like Cursor, but used when in IME mode |CursorIM|
    ...
    Pmenu = {
      bg = (theme.meta.light == false and color.darken(theme.palette.bg, 0.85) or color.darken(theme.palette.bg, 0.95)),
    }, -- Popup menu: normal item.
    PmenuSel = {
      bg = (
          theme.meta.light == false and color.lighten(theme.palette.bg, 0.97)
    ...
    PmenuThumb = {
      bg = (theme.meta.light == false and color.lighten(theme.palette.bg, 0.5) or color.darken(theme.palette.bg, 0.5)),
