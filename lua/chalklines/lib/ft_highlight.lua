...
local store = {
  highlights = require('chalklines.highlight').ft,
  default_highlights = {},
  filetypes = {},
  last_filetype = nil,
}
...
local function set_highlights()
  for ft, ns in pairs(store.filetypes) do
    require('chalklines.lib.highlight').neovim_hl(store.highlights[ft], ns)
  end
end
...
local function set_autocmds()
  local augroup = vim.api.nvim_create_augroup('ChalklinesFiletypeHighlights', { clear = true })

  vim.api.nvim_create_autocmd('BufEnter,BufRead', {
    group = augroup,
    command = [[lua vim.schedule(function() require("chalklines.lib.ft_highlight").load() end)]],
  })
  vim.api.nvim_create_autocmd('ColorScheme', {
    group = augroup,
    command = [[lua vim.schedule(function() require("chalklines.lib.ft_highlight").reset() end)]],
  })
end
...
---@return nil
function M.reset()
  store.highlights = require('chalklines.highlight').ft
  set_highlights()
end
