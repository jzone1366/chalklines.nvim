...
function M.get(cnf)
  ...
  return {
    ...
    -- EndOfBuffer = {},
    ErrorMsg = { fg = colorMaps.error, style = 'bold' },
    ...
    NvimInternalError = { fg = p.white, bg = colorMaps.error },
    ...
    RedrawDebugRecompose = { fg = p.white, bg = colorMaps.error },
    Search = { bg = p.hl_med },
    ...
    Visual = { bg = p.hl_med },
    -- VisualNOS = {},
    WarningMsg = { fg = colorMaps.warning },
    -- Whitespace = {},
    -- WildMenu = {},
  }
end
