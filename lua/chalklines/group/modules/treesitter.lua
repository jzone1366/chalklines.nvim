...
function M.get(cnf)
  ...
  return {
    ...
    TSError = { fg = p.red1 }, -- Syntax/parser errors. This might highlight large sections of code while the user is typing still incomplete code, use a sensible highlight.
